    ...
    return (
      <div className="bg-neutral-800 border border-neutral-700 p-3 rounded-lg shadow-lg">
        ...
        <p className="text-neutral-300">
          Valor: <span className="font-semibold">{transformToCurrency(data.value)}</span>
        </p>
        <p className="text-neutral-300">
          ...
          <p key={index} className="text-neutral-300">
            <span style={{ color: entry.color }}>
              {entry.dataKey === 'income' ? 'Receitas' : 
               entry.dataKey === 'expense' ? 'Despesas' : 'Saldo'}:
            </span>{' '}
            <span className="font-semibold">{transformToCurrency(entry.value)}</span>
          </p>
        ))}
      </div>
    );
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm text-green-400 font-medium">Receitas Totais</span>
                </div>
              ...
              <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm text-red-400 font-medium">Despesas Totais</span>
                </div>
