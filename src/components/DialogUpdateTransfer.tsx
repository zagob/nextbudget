...
interface DialogUpdateTransferProps {
  transferId: string;
  defaultValues: FormData;
}

export function DialogUpdateTransfer({ transferId, defaultValues }: DialogUpdateTransferProps) {
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <DialogHeader className="mb-2">
              ...
              <DialogDescription>
                Atualizar transferência com o ID: {transferId}
              </DialogDescription>
            </DialogHeader>
